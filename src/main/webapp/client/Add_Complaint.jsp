		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item active"><a href="Add_Complaint.jsp" class="nav-link">Contact Us</a></li>
		...
		<div class="container">
			<div class="row d-flex mb-5 contact-info">
				...
				<div class="col-md-8 block-9 mb-md-5">
					<form action="/online_bus_ticket/SubmitComplaint" method="post" class="bg-light p-5 contact-form">
					<div class="form-group">
						<label for="fullName">Full Name:</label> <input type="text"
							class="form-control" name="fullName" required>
						</div><div class="form-group">
						 <label for="email">Email:</label> <input type="email"
							class="form-control" name="email" required><br></div>
						
						<div class="form-group"> <label for="complaint">Complaint:</label><br>
						<textarea class="form-control"name="complaint" rows="4" cols="50"
							required></textarea>
						 
						</div><input type="hidden" id="c_status" name="c_status"
							value="Unread"> 
							<div class="form-group"><input type="submit"
							value="Submit Complaint"  class="btn btn-primary py-3 px-5"></div>
					</form>
				</div>
			</div>
