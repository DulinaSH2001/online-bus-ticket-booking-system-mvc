...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/style.css">
     <script>
        setTimeout(function(){
            window.location.href = "Add_Complaint.jsp"; // Redirect to the complaint page after 5 seconds
    ...
    <section class="ftco-section contact-section">
     <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Complaint Submitted Successfully!</div>
                    <div class="card-body">
                        <p>Your complaint has been submitted. You will be redirected back to the complaint page in 5 seconds.</p>
                        <p>If you are not automatically redirected, <a href="contact.html">click here</a>.</p>
                    </div>
                </div>
            </div>
        </div>
