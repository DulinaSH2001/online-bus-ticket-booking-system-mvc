	...
	<div class="wrapper">
		...
		<div class="sidebar">
			<div class="scrollbar-inner sidebar-wrapper">
				<ul class="nav">
					<li class="nav-item active"><a href="AdminDashboard.jsp">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								try {
									...
									String sql = "SELECT * FROM routes WHERE r_id=?";
								...
								%>
								<form action="/online_bus_ticket/updateRoute" method="post">
									<input type="hidden" name="routeId" name="routeId"
										value="<%=routeId%>">
									<div class="form-group">
										<label for="fromLocation">From Location:</label> <input
											type="text" class="form-control" id="fromLocation"
											name="fromLocation" value="<%=fromLocation%>" required>
									</div>
									<div class="form-group">
										<label for="toLocation">To Location:</label> <input
											type="text" id="toLocation" name="toLocation"
											class="form-control" value="<%=toLocation%>" required>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label for="finishTime">Finish Time:</label> <input
											...
											name="finishTime" value="<%=finishTime%>" required>
									</div>
									<div class="form-group">
										<label for="routeNumber">Route Number:</label> <input
											type="text" id="routeNumber" name="routeNumber"
											class="form-control" value="<%=routeNumber%>" required>
									</div>
									<div class="form-group">
										<label for="busRegNum">Bus Registration Number:</label> <input
											type="text" id="busRegNum" name="busRegNum"
											value="<%=busRegNum%>" class="form-control" required>
									</div>
									<div class="form-group">
										...
										<label for="availability">Availability:</label> <select
											...
											<option value="1" <%=availability == 1 ? "selected" : ""%>>Yes</option>
											<option value="0" <%=availability == 0 ? "selected" : ""%>>No</option>
										</select>
									</div>
									<div class="form-group">
										<label for="price">Price:</label> <input class="form-control"
											type="number" id="price" name="price" value="<%=price%>"
											required>
									</div>
									<div class="form-group">

										<label for="seats">Seats:</label> <input type="number"
											class="form-control" id="seats" name="seats"
											value="<%=seats%>" required>
									</div>
									<div class="form-group">
										<label for="airConditioned">Air Conditioned:</label> <select
											class="form-control" id="airConditioned"
											name="airConditioned">
											<option value="1" <%=airConditioned == 1 ? "selected" : ""%>>AC</option>
											<option value="0" <%=airConditioned == 0 ? "selected" : ""%>>Non-AC</option>
